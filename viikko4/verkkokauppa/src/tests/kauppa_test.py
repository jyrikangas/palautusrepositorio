...
class TestKauppa(unittest.TestCase):
    ...
    def test_osta_kaksi_eri_tuotetta_tilisiirto_kutsutaan_oikein(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_osta_kaksi_samaa_tuotetta_tilisiirto_kutsutaan_oikein(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_osta_kaksi_eri_tuotetta_joista_toinen_loppu_tilisiirto_kutsutaan_oikein(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_aloita_asiointi_aloittaa_alusta(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
    ...
    def test_pyytaa_uuden_viitteen_jokaiseen_maksuun(self):
